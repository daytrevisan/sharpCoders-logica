// Leia um caracter maiúsculo que indica a operação a ser performada (soma ou média) e aplique a operação a todos os números que estão abaixo da diagnonal principal do array bidimensional M[12][12]
